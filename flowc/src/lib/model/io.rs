...
pub struct IO {
    ...
    #[serde(rename = "type", default = "default_types", deserialize_with = "super::datatype_array_serde::datatype_or_datatype_array")]
...
impl IO {
    ...
    // TODO move these two methods into test module when working
    
    /// Create a new `IO` with a specific datatype and at a specific `Route`
    #[cfg(test)]
    pub fn new<D: Into<&[DataType]>, R: Into<Route>>(datatypes: D, route: R) -> Self {
        IO {
            datatypes: datatypes.into(),
            route: route.into(),
            ..Default::default()
        }
    }
    ...
    #[cfg(test)]
    pub fn new_named<D: Into<&[DataType]>, R: Into<Route>, N: Into<Name>>(
        datatypes: D,
        route: R,
        name: N,
    ) -> Self {
