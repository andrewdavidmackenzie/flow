...
- [Arg functions](flowr/src/cli_context/args/args.md)
    - [Arg get function](flowr/src/cli_context/args/get.md)
- [File functions](flowr/src/cli_context/file/file.md)
    - [File Write function](flowr/src/cli_context/file/file_write.md)
- [Image manipulation functions](flowr/src/cli_context/image/image.md)
    - [Image buffer](flowr/src/cli_context/image/image_buffer.md)
- [Standard IO functions](flowr/src/cli_context/stdio/stdio.md)
    - [Readline function](flowr/src/cli_context/stdio/readline.md)
    - [Standard Input function](flowr/src/cli_context/stdio/stdin.md)
    - [Standard Output function](flowr/src/cli_context/stdio/stdout.md)
    - [Standard Error function](flowr/src/cli_context/stdio/stderr.md)
