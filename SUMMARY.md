...
- [Standard IO functions](flowr/src/lib/flowruntime/stdio/stdio.md)
    - [Readline function](flowr/src/lib/flowruntime/stdio/readline.md)
    - [Standard Input function](flowr/src/lib/flowruntime/stdio/stdin.md)
    - [Standard Output function](flowr/src/lib/flowruntime/stdio/stdout.md)
