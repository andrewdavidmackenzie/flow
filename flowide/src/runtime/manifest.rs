...
pub fn get_manifest(args: &Vec<String>) -> LibraryManifest {
    ...
    manifest.locators.insert("lib://runtime/args/get/Get".to_string(), Native(Arc::new(super::args::get::Get::new(args))));
